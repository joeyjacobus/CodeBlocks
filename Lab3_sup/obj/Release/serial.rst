                              ...
                              4 ; This file generated Tue Oct 18 19:35:41 2016
                              5 ;--------------------------------------------------------
                              6 	.module serial
   ...
   0008                     428 	.ds 3
                            ...
                            447 ;--------------------------------------------------------
                            448 	.area XSEG    (XDATA)
   0003                     449 _putchar_c_1_1:
   0003                     450 	.ds 1
   0004                     451 _Serial_GetInteger_max_length_1_1:
   0004                     452 	.ds 2
   0006                     453 _Serial_GetInteger_buf_1_1:
   0006                     454 	.ds 11
   0011                     455 _Serial_GetInteger_index_1_1:
   0011                     456 	.ds 2
   0013                     457 _getstring_PARM_2:
   0013                     458 	.ds 2
   0015                     459 _getstring_buf_1_1:
   0015                     460 	.ds 3
   0018                     461 _getstring_c_1_1:
   0018                     462 	.ds 1
                            463 ;--------------------------------------------------------
   ...
   0424                     502 _putchar:
                    ...
                    0001    510 	ar1 = 0x01
                            511 ;	genReceive
   0424 E5 82               512 	mov	a,dpl
   0426 90 00 03            513 	mov	dptr,#_putchar_c_1_1
   0429 F0                  514 	movx	@dptr,a
                            515 ;	serial.c:25: while (TI == 0);
   042A                     516 00101$:
                            517 ;	genIfx
                            518 ;	genIfxJump
                            519 ;	Peephole 108.d	removed ljmp by inverse jump logic
   042A 30 99 FD            520 	jnb	_TI,00101$
                            521 ;	Peephole 300	removed redundant label 00108$
                            522 ;	serial.c:26: SBUF = c; // load serial port with transmit value
                            523 ;	genAssign
   042D 90 00 03            524 	mov	dptr,#_putchar_c_1_1
   0430 E0                  525 	movx	a,@dptr
   0431 F5 99               526 	mov	_SBUF,a
                            527 ;	serial.c:27: TI = 0; // clear TI flag
                            528 ;	genAssign
   0433 C2 99               529 	clr	_TI
   ...
   0436 10 98 02            549 	jbc	_RI,00108$
   0439 80 FB               550 	sjmp	00101$
   043B                     551 00108$:
                            552 ;	serial.c:34: return SBUF; // return character from SBUF
                            553 ;	genAssign
   043B AA 99               554 	mov	r2,_SBUF
                            555 ;	genRet
   043D 8A 82               556 	mov	dpl,r2
   ...
   043F 22                  558 	ret
                            ...
                            570 ;	-----------------------------------------
   0440                     571 _Serial_GetInteger:
                            572 ;	genReceive
   0440 AA 83               573 	mov	r2,dph
   0442 E5 82               574 	mov	a,dpl
   0444 90 00 04            575 	mov	dptr,#_Serial_GetInteger_max_length_1_1
   0447 F0                  576 	movx	@dptr,a
   0448 A3                  577 	inc	dptr
   0449 EA                  578 	mov	a,r2
   044A F0                  579 	movx	@dptr,a
                            580 ;	serial.c:46: int index = 0;
                            581 ;	genAssign
   044B 90 00 11            582 	mov	dptr,#_Serial_GetInteger_index_1_1
   044E E4                  583 	clr	a
   044F F0                  584 	movx	@dptr,a
   0450 A3                  585 	inc	dptr
   0451 F0                  586 	movx	@dptr,a
                            587 ;	serial.c:48: if (max_length > 10){
                            588 ;	genAssign
   0452 90 00 04            589 	mov	dptr,#_Serial_GetInteger_max_length_1_1
   0455 E0                  590 	movx	a,@dptr
   0456 FA                  591 	mov	r2,a
   0457 A3                  592 	inc	dptr
   0458 E0                  593 	movx	a,@dptr
   0459 FB                  594 	mov	r3,a
                            595 ;	genCmpGt
                            596 ;	genCmp
   045A C3                  597 	clr	c
   045B 74 0A               598 	mov	a,#0x0A
   045D 9A                  599 	subb	a,r2
                            600 ;	Peephole 159	avoided xrl during execution
   045E 74 80               601 	mov	a,#(0x00 ^ 0x80)
   0460 8B F0               602 	mov	b,r3
   0462 63 F0 80            603 	xrl	b,#0x80
   0465 95 F0               604 	subb	a,b
                            605 ;	genIfxJump
                            606 ;	Peephole 108.a	removed ljmp by inverse jump logic
   0467 50 19               607 	jnc	00125$
                            608 ;	Peephole 300	removed redundant label 00128$
                            609 ;	serial.c:49: printf("Serial_getInteger(): Error. Max_Length too large.");
                            610 ;	genIpush
   0469 74 48               611 	mov	a,#__str_0
   046B C0 E0               612 	push	acc
   046D 74 14               613 	mov	a,#(__str_0 >> 8)
   046F C0 E0               614 	push	acc
   0471 74 80               615 	mov	a,#0x80
   0473 C0 E0               616 	push	acc
                            617 ;	genCall
   0475 12 08 C0            618 	lcall	_printf
   0478 15 81               619 	dec	sp
   047A 15 81               620 	dec	sp
   047C 15 81               621 	dec	sp
                            622 ;	serial.c:50: return -1;
                            623 ;	genRet
                            624 ;	Peephole 182.b	used 16 bit load of dptr
   047E 90 FF FF            625 	mov	dptr,#0xFFFF
   ...
   0482                     631 00116$:
                            632 ;	genAssign
   0482 90 00 11            633 	mov	dptr,#_Serial_GetInteger_index_1_1
   0485 E0                  634 	movx	a,@dptr
   0486 FC                  635 	mov	r4,a
   0487 A3                  636 	inc	dptr
   0488 E0                  637 	movx	a,@dptr
   0489 FD                  638 	mov	r5,a
                            639 ;	genCmpLt
                            640 ;	genCmp
   048A C3                  641 	clr	c
   048B EC                  642 	mov	a,r4
   048C 9A                  643 	subb	a,r2
   048D ED                  644 	mov	a,r5
   048E 64 80               645 	xrl	a,#0x80
   0490 8B F0               646 	mov	b,r3
   0492 63 F0 80            647 	xrl	b,#0x80
   0495 95 F0               648 	subb	a,b
                            649 ;	genIfxJump
   0497 40 03               650 	jc	00129$
   0499 02 05 41            651 	ljmp	00118$
   049C                     652 00129$:
                            653 ;	serial.c:54: c = getchar();
                            654 ;	genCall
   049C C0 02               655 	push	ar2
   049E C0 03               656 	push	ar3
   04A0 C0 04               657 	push	ar4
   04A2 C0 05               658 	push	ar5
   04A4 12 04 36            659 	lcall	_getchar
   04A7 AE 82               660 	mov	r6,dpl
   04A9 D0 05               661 	pop	ar5
   04AB D0 04               662 	pop	ar4
   04AD D0 03               663 	pop	ar3
   04AF D0 02               664 	pop	ar2
                            665 ;	serial.c:55: putchar(c);
                            666 ;	genCall
   04B1 8E 82               667 	mov	dpl,r6
   04B3 C0 02               668 	push	ar2
   04B5 C0 03               669 	push	ar3
   04B7 C0 04               670 	push	ar4
   04B9 C0 05               671 	push	ar5
   04BB C0 06               672 	push	ar6
   04BD 12 04 24            673 	lcall	_putchar
   04C0 D0 06               674 	pop	ar6
   04C2 D0 05               675 	pop	ar5
   04C4 D0 04               676 	pop	ar4
   04C6 D0 03               677 	pop	ar3
   04C8 D0 02               678 	pop	ar2
                            679 ;	serial.c:56: if (c == ENTER_KEY)
                            680 ;	genCmpEq
                            681 ;	gencjneshort
   04CA BE 0D 03            682 	cjne	r6,#0x0D,00130$
   04CD 02 05 41            683 	ljmp	00118$
   04D0                     684 00130$:
   ...
   04D0 BE 08 12            690 	cjne	r6,#0x08,00111$
                            ...
                            695 ;	genMinus
                            696 ;	genMinusDec
   04D3 EC                  697 	mov	a,r4
   04D4 24 FF               698 	add	a,#0xff
   04D6 FF                  699 	mov	r7,a
   04D7 ED                  700 	mov	a,r5
   04D8 34 FF               701 	addc	a,#0xff
   04DA F8                  702 	mov	r0,a
                            703 ;	genAssign
   04DB 90 00 11            704 	mov	dptr,#_Serial_GetInteger_index_1_1
   04DE EF                  705 	mov	a,r7
   04DF F0                  706 	movx	@dptr,a
   04E0 A3                  707 	inc	dptr
   04E1 E8                  708 	mov	a,r0
   04E2 F0                  709 	movx	@dptr,a
                            710 ;	Peephole 112.b	changed ljmp to sjmp
   04E3 80 9D               711 	sjmp	00116$
   04E5                     712 00111$:
                            713 ;	serial.c:60: else if (c == 'q' || c == 'Q'){
                            714 ;	genCmpEq
                            715 ;	gencjneshort
   04E5 BE 71 02            716 	cjne	r6,#0x71,00133$
                            717 ;	Peephole 112.b	changed ljmp to sjmp
   04E8 80 03               718 	sjmp	00106$
   04EA                     719 00133$:
                            720 ;	genCmpEq
                            721 ;	gencjneshort
                            722 ;	Peephole 112.b	changed ljmp to sjmp
                            723 ;	Peephole 198.b	optimized misc jump sequence
   04EA BE 51 04            724 	cjne	r6,#0x51,00107$
   ...
   04ED 90 FF FE            732 	mov	dptr,#0xFFFE
                            733 ;	Peephole 251.a	replaced ljmp to ret with ret
   04F0 22                  734 	ret
   04F1                     735 00107$:
                            736 ;	serial.c:63: else if ( isdigit(c) ){
                            737 ;	genCall
   04F1 8E 82               738 	mov	dpl,r6
   04F3 C0 02               739 	push	ar2
   04F5 C0 03               740 	push	ar3
   04F7 C0 04               741 	push	ar4
   04F9 C0 05               742 	push	ar5
   04FB C0 06               743 	push	ar6
   04FD 12 06 EB            744 	lcall	_isdigit
   0500 E5 82               745 	mov	a,dpl
   0502 D0 06               746 	pop	ar6
   0504 D0 05               747 	pop	ar5
   0506 D0 04               748 	pop	ar4
   0508 D0 03               749 	pop	ar3
   050A D0 02               750 	pop	ar2
                            751 ;	genIfx
                            752 ;	genIfxJump
                            753 ;	Peephole 108.c	removed ljmp by inverse jump logic
   050C 60 1A               754 	jz	00104$
                            755 ;	Peephole 300	removed redundant label 00136$
                            756 ;	serial.c:64: buf[index] = c;
                            757 ;	genPlus
                            758 ;	Peephole 236.g	used r4 instead of ar4
   050E EC                  759 	mov	a,r4
   050F 24 06               760 	add	a,#_Serial_GetInteger_buf_1_1
   0511 F5 82               761 	mov	dpl,a
                            762 ;	Peephole 236.g	used r5 instead of ar5
   0513 ED                  763 	mov	a,r5
   0514 34 00               764 	addc	a,#(_Serial_GetInteger_buf_1_1 >> 8)
   0516 F5 83               765 	mov	dph,a
                            766 ;	genPointerSet
                            767 ;     genFarPointerSet
   0518 EE                  768 	mov	a,r6
   0519 F0                  769 	movx	@dptr,a
                            770 ;	serial.c:65: ++index;
                            771 ;	genPlus
   051A 90 00 11            772 	mov	dptr,#_Serial_GetInteger_index_1_1
                            773 ;     genPlusIncr
   051D 74 01               774 	mov	a,#0x01
                            775 ;	Peephole 236.a	used r4 instead of ar4
   051F 2C                  776 	add	a,r4
   0520 F0                  777 	movx	@dptr,a
                            778 ;	Peephole 181	changed mov to clr
   0521 E4                  779 	clr	a
                            780 ;	Peephole 236.b	used r5 instead of ar5
   0522 3D                  781 	addc	a,r5
   0523 A3                  782 	inc	dptr
   0524 F0                  783 	movx	@dptr,a
   0525 02 04 82            784 	ljmp	00116$
   0528                     785 00104$:
                            786 ;	serial.c:68: printf("\r\nInvalid character. Enter only digits.");
                            787 ;	genIpush
   0528 74 7A               788 	mov	a,#__str_1
   052A C0 E0               789 	push	acc
   052C 74 14               790 	mov	a,#(__str_1 >> 8)
   052E C0 E0               791 	push	acc
   0530 74 80               792 	mov	a,#0x80
   0532 C0 E0               793 	push	acc
                            794 ;	genCall
   0534 12 08 C0            795 	lcall	_printf
   0537 15 81               796 	dec	sp
   0539 15 81               797 	dec	sp
   053B 15 81               798 	dec	sp
                            799 ;	serial.c:69: return -1;
                            800 ;	genRet
                            801 ;	Peephole 182.b	used 16 bit load of dptr
   053D 90 FF FF            802 	mov	dptr,#0xFFFF
   ...
   0541                     806 00118$:
                            ...
                            808 ;	genAssign
   0541 90 00 11            809 	mov	dptr,#_Serial_GetInteger_index_1_1
   0544 E0                  810 	movx	a,@dptr
   0545 FA                  811 	mov	r2,a
   0546 A3                  812 	inc	dptr
   0547 E0                  813 	movx	a,@dptr
   0548 FB                  814 	mov	r3,a
                            815 ;	genPlus
                            816 ;	Peephole 236.g	used r2 instead of ar2
   0549 EA                  817 	mov	a,r2
   054A 24 06               818 	add	a,#_Serial_GetInteger_buf_1_1
   054C F5 82               819 	mov	dpl,a
                            820 ;	Peephole 236.g	used r3 instead of ar3
   054E EB                  821 	mov	a,r3
   054F 34 00               822 	addc	a,#(_Serial_GetInteger_buf_1_1 >> 8)
   0551 F5 83               823 	mov	dph,a
                            824 ;	genPointerSet
                            825 ;     genFarPointerSet
                            826 ;	Peephole 181	changed mov to clr
   0553 E4                  827 	clr	a
   0554 F0                  828 	movx	@dptr,a
                            829 ;	serial.c:73: return atoi(buf);
                            830 ;	genCall
                            831 ;	Peephole 182.a	used 16 bit load of DPTR
   0555 90 00 06            832 	mov	dptr,#_Serial_GetInteger_buf_1_1
   0558 75 F0 00            833 	mov	b,#0x00
                            834 ;	genRet
                            835 ;	Peephole 150.b	removed misc moves via dph, dpl before return
                            836 ;	Peephole 253.b	replaced lcall/ret with ljmp
   055B 02 07 08            837 	ljmp	_atoi
                            838 ;
                            839 ;------------------------------------------------------------
   ...
   055E                     852 _getstring:
                            853 ;	genReceive
   055E AA F0               854 	mov	r2,b
   0560 AB 83               855 	mov	r3,dph
   0562 E5 82               856 	mov	a,dpl
   0564 90 00 15            857 	mov	dptr,#_getstring_buf_1_1
   0567 F0                  858 	movx	@dptr,a
   0568 A3                  859 	inc	dptr
   0569 EB                  860 	mov	a,r3
   056A F0                  861 	movx	@dptr,a
   056B A3                  862 	inc	dptr
   056C EA                  863 	mov	a,r2
   056D F0                  864 	movx	@dptr,a
                            865 ;	serial.c:80: c = getchar();
                            866 ;	genCall
   056E 12 04 36            867 	lcall	_getchar
   0571 AA 82               868 	mov	r2,dpl
                            869 ;	genAssign
   0573 90 00 18            870 	mov	dptr,#_getstring_c_1_1
   0576 EA                  871 	mov	a,r2
   0577 F0                  872 	movx	@dptr,a
                            873 ;	serial.c:81: putchar(c);
                            874 ;	genCall
   0578 8A 82               875 	mov	dpl,r2
   057A 12 04 24            876 	lcall	_putchar
                            877 ;	serial.c:82: while(c != ENTER_KEY && offset < length){
                            878 ;	genAssign
   057D 90 00 13            879 	mov	dptr,#_getstring_PARM_2
   0580 E0                  880 	movx	a,@dptr
   0581 FA                  881 	mov	r2,a
   0582 A3                  882 	inc	dptr
   0583 E0                  883 	movx	a,@dptr
   0584 FB                  884 	mov	r3,a
                            885 ;	genAssign
   0585 90 00 15            886 	mov	dptr,#_getstring_buf_1_1
   0588 E0                  887 	movx	a,@dptr
   0589 F5 08               888 	mov	_getstring_sloc0_1_0,a
   058B A3                  889 	inc	dptr
   058C E0                  890 	movx	a,@dptr
   058D F5 09               891 	mov	(_getstring_sloc0_1_0 + 1),a
   058F A3                  892 	inc	dptr
   0590 E0                  893 	movx	a,@dptr
   0591 F5 0A               894 	mov	(_getstring_sloc0_1_0 + 2),a
                            895 ;	genAssign
   0593 7F 00               896 	mov	r7,#0x00
   0595 78 00               897 	mov	r0,#0x00
   0597                     898 00102$:
                            899 ;	genAssign
   0597 90 00 18            900 	mov	dptr,#_getstring_c_1_1
   059A E0                  901 	movx	a,@dptr
   059B F9                  902 	mov	r1,a
                            903 ;	genCmpEq
                            904 ;	gencjneshort
   059C B9 0D 02            905 	cjne	r1,#0x0D,00111$
                            906 ;	Peephole 112.b	changed ljmp to sjmp
   059F 80 5D               907 	sjmp	00104$
   05A1                     908 00111$:
                            909 ;	genCmpLt
                            910 ;	genCmp
   05A1 C3                  911 	clr	c
   05A2 EF                  912 	mov	a,r7
   05A3 9A                  913 	subb	a,r2
   05A4 E8                  914 	mov	a,r0
   05A5 64 80               915 	xrl	a,#0x80
   05A7 8B F0               916 	mov	b,r3
   05A9 63 F0 80            917 	xrl	b,#0x80
   05AC 95 F0               918 	subb	a,b
                            919 ;	genIfxJump
                            920 ;	Peephole 108.a	removed ljmp by inverse jump logic
   05AE 50 4E               921 	jnc	00104$
                            922 ;	Peephole 300	removed redundant label 00112$
                            923 ;	serial.c:83: buf[offset] = c;
                            924 ;	genIpush
   05B0 C0 02               925 	push	ar2
   05B2 C0 03               926 	push	ar3
                            927 ;	genPlus
                            928 ;	Peephole 236.g	used r7 instead of ar7
   05B4 EF                  929 	mov	a,r7
   05B5 25 08               930 	add	a,_getstring_sloc0_1_0
   05B7 FA                  931 	mov	r2,a
                            932 ;	Peephole 236.g	used r0 instead of ar0
   05B8 E8                  933 	mov	a,r0
   05B9 35 09               934 	addc	a,(_getstring_sloc0_1_0 + 1)
   05BB FB                  935 	mov	r3,a
   05BC AC 0A               936 	mov	r4,(_getstring_sloc0_1_0 + 2)
                            937 ;	genPointerSet
                            938 ;	genGenPointerSet
   05BE 8A 82               939 	mov	dpl,r2
   05C0 8B 83               940 	mov	dph,r3
   05C2 8C F0               941 	mov	b,r4
   05C4 E9                  942 	mov	a,r1
   05C5 12 08 3B            943 	lcall	__gptrput
                            944 ;	serial.c:84: c = getchar();
                            945 ;	genCall
   05C8 C0 03               946 	push	ar3
   05CA C0 07               947 	push	ar7
   05CC C0 00               948 	push	ar0
   05CE 12 04 36            949 	lcall	_getchar
   05D1 AA 82               950 	mov	r2,dpl
   05D3 D0 00               951 	pop	ar0
   05D5 D0 07               952 	pop	ar7
   05D7 D0 03               953 	pop	ar3
                            954 ;	genAssign
   05D9 90 00 18            955 	mov	dptr,#_getstring_c_1_1
   05DC EA                  956 	mov	a,r2
   05DD F0                  957 	movx	@dptr,a
                            958 ;	serial.c:85: putchar(c);
                            959 ;	genCall
   05DE 8A 82               960 	mov	dpl,r2
   05E0 C0 02               961 	push	ar2
   05E2 C0 03               962 	push	ar3
   05E4 C0 07               963 	push	ar7
   05E6 C0 00               964 	push	ar0
   05E8 12 04 24            965 	lcall	_putchar
   05EB D0 00               966 	pop	ar0
   05ED D0 07               967 	pop	ar7
   05EF D0 03               968 	pop	ar3
   05F1 D0 02               969 	pop	ar2
                            970 ;	serial.c:87: ++offset;
                            971 ;	genPlus
                            972 ;     genPlusIncr
   05F3 0F                  973 	inc	r7
   05F4 BF 00 01            974 	cjne	r7,#0x00,00113$
   05F7 08                  975 	inc	r0
   05F8                     976 00113$:
                            977 ;	genIpop
   05F8 D0 03               978 	pop	ar3
   05FA D0 02               979 	pop	ar2
                            980 ;	Peephole 112.b	changed ljmp to sjmp
   05FC 80 99               981 	sjmp	00102$
   05FE                     982 00104$:
                            983 ;	serial.c:91: buf[offset] = '\0';
                            984 ;	genAssign
   05FE 90 00 15            985 	mov	dptr,#_getstring_buf_1_1
   0601 E0                  986 	movx	a,@dptr
   0602 FA                  987 	mov	r2,a
   0603 A3                  988 	inc	dptr
   0604 E0                  989 	movx	a,@dptr
   0605 FB                  990 	mov	r3,a
   0606 A3                  991 	inc	dptr
   0607 E0                  992 	movx	a,@dptr
   0608 FC                  993 	mov	r4,a
                            994 ;	genPlus
                            995 ;	Peephole 236.g	used r7 instead of ar7
   0609 EF                  996 	mov	a,r7
                            997 ;	Peephole 236.a	used r2 instead of ar2
   060A 2A                  998 	add	a,r2
   060B FF                  999 	mov	r7,a
                           1000 ;	Peephole 236.g	used r0 instead of ar0
   060C E8                 1001 	mov	a,r0
                           1002 ;	Peephole 236.b	used r3 instead of ar3
   060D 3B                 1003 	addc	a,r3
   060E F8                 1004 	mov	r0,a
   060F 8C 05              1005 	mov	ar5,r4
                           1006 ;	genPointerSet
                           1007 ;	genGenPointerSet
   0611 8F 82              1008 	mov	dpl,r7
   0613 88 83              1009 	mov	dph,r0
   0615 8D F0              1010 	mov	b,r5
                           1011 ;	Peephole 181	changed mov to clr
   0617 E4                 1012 	clr	a
                           1013 ;	Peephole 253.b	replaced lcall/ret with ljmp
   0618 02 08 3B           1014 	ljmp	__gptrput
                           1015 ;
                           1016 ;------------------------------------------------------------
   ...
   1448 53 65 72 69 61 6C  1048 	.ascii "Serial_getInteger(): Error. Max_Length too large."
        ...
        20 6C 61 72 67 65
        2E
   1479 00                 1049 	.db 0x00
   147A                    1050 __str_1:
   147A 0D                 1051 	.db 0x0D
   147B 0A                 1052 	.db 0x0A
   147C 49 6E 76 61 6C 69  1053 	.ascii "Invalid character. Enter only digits."
        64 20 63 68 61 72
        61 63 74 65 72 2E
        20 45 6E 74 65 72
        20 6F 6E 6C 79 20
